...
app.layout = html.Div(id="page", children=(html.Div(id="input_cells", children=(html.H1(id='text', children = "Ввод"),
                      ...
                      html.Div(id="tree_put", children=(html.Div(id="pretty_tree_put", children=(dash_table.DataTable())), html.Div(id="pretty_opt_put", children=(dash_table.DataTable()))),style={"display" : "inline-block"})), style={'display':'flex'})
...
@app.callback([Output("table_update", "children"), Output("pretty_tree", "children"), Output("pretty_opt", "children"), Output("pretty_tree_put", "children"), Output("pretty_opt_put", "children")], [Input("price_field", "value"), Input("strike_field", "value"), Input("sigma_field", "value"), Input("risk_free_field", "value"), Input("start_date_field", 'start_date'), Input("start_date_field", 'end_date'), Input("type_choice", "value")])
