...
futures_list = pd.read_excel("true_futures_ids.xlsx")[0]
...
futures_list = html.Div(
    ...
    options=futures_list,
    placeholder='Выбор по типам',
    style = {'marginRight':"25px",
             'marginLeft':"8px",
             "width" : "370px",
             'display': 'none'}),
                            ...
                            html.Div(style = {'width':'470px', "margin":"20px 0px 0px 100px"},
                                    children = [
                                        ...
                                        html.Div(style={'width':'450px',
                                                        ...
                                                        "border-radius":"10px"},
                                                 id="input_div",
                                                children =[asset_list, futures_list, type_choice, price_field, strike_field, sigma_field, risk_free_field, date_field]),
                                    html.Div(figure),
                                    html.Div(button)]),
...
@app.callback([[Output("price_field", "value"), Output("strike_field", "value"), Output("sigma_field", "value"), Output("date_field", "end_date")],
               ...
               Output("futures_list", "style")],
              Input("asset_list", "value"), Input("type_choice", "value"), Input("futures_list", "value"))
def get_attributes(asset, type_choice, futures):
    if asset==None:
        return [no_update, no_update, no_update, no_update], figure, html.Div(), html.Div(), {}, {'marginRight':"25px",
             'marginLeft':"8px",
             'marginTop':"30px",
             "width" : "370px",
             'display': 'none'}

    call, put, params, fig, index = get_board(asset) if futures==None else get_board(futures)
    ...
    if (globals()["on_type_check"]!=type_choice and globals()["on_asset_check"]==asset):
        ...
        return [no_update, no_update, no_update, no_update], pic, call_board, put_board, clear_style, {'marginRight':"25px",
             'marginLeft':"8px",
             'marginTop':"30px",
             "width" : "370px"}
    globals()["on_type_check"] = type_choice
    globals()["on_asset_check"] = asset
    return params, pic, call_board, put_board, clear_style, {'marginRight':"25px",
             'marginLeft':"8px",
             'marginTop':"30px",
             "width" : "370px"}
